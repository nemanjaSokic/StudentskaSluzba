...
public class PredmetUI {
	...
	private static void sortiranjePredmetaPoNazivu() throws SQLException {
		List<Predmet> sviPredmeti = new ArrayList<Predmet>();
		sviPredmeti = PredmetDAO.sortedByNaziv(ApplicationUI.conn);
	...
	public static void ispisiMenu() {
		...
		System.out.println("\tOpcija broj 5 - sortiraj predmete po nazivu");
		System.out.println("\t\t ...");
